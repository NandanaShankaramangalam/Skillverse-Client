...
try{
 console.log('a',profileFile);
  ...
  ValidateEditProfile(selectedProfile,niche,selectedImage,description,err,setErr)
...
//         const profileResponse = await s3.upload(profileParams).promise();
//         const profileLoc = `${profileResponse.Key}`;
//         setProfileLocation(profileLoc);
//         console.log('Profile location:', profileLoc);
//         console.log('Profile upload success:', profileResponse);
...
//         const bannerResponse = await s3.upload(bannerParams).promise();
//         const bannerLoc = `${bannerResponse.Key}`;
//         setBannerLocation(bannerLoc);
//         console.log('banner location:', bannerLoc);
//         console.log('banner upload success:', bannerResponse);
...
//       const result = await api.post(`/tutor/edit-profile/${tutId}`, {
//         profileLocation,
//         bannerLocation,
//         niche,
//         description,
        ...
        <div className="absolute inset-0  top-20 left-72 flex items-center justify-center z-50 ">
          <div className="bg-white p-6 rounded-lg h-96 overflow-y-scroll  shadow-lg">
            ...
            <input accept="image/jpeg,image/png,image/gif" name="profile"
             ...
             className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-700 dark:placeholder-gray-400" aria-describedby="file_input_help" id="formInputControl4" type="file"/>
            ...
            <input accept="image/jpeg,image/png,image/gif" name="banner"
