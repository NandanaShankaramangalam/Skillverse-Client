...
function CourseTutorial() {
   ...
   return (
    <div>
       <div className={`grid grid-cols-12  h-screen relative ${isEditing ? 'blur' : ''}`}> 
      ...
      <div className='bg-white h-3/4 w-2/4 mt-10 rounded-md overflow-y-auto pb-10'>
        <div className='flex justify-end pt-3 pe-3'>
          <button onClick={() => setIsEditing(false)}>
            <FontAwesomeIcon icon={faXmark} className='font-thin text-4xl text-gray-400'></FontAwesomeIcon>
          </button>
        </div>
        ...
        <div>
          ...
          <div>
          <label className="block mb-1 text-sm font-medium text-gray-900" htmlFor="file_input">Upload Thumbnail</label>
          ...
          <div className="flex items-center justify-center w-full">
            ...
            <button onClick={(e)=>handleUndo(e)} className="bg-custom-blue text-white py-2 px-6 text-sm rounded-md  hover:bg-gray-700 transition duration-150 ease-out">
             Undo Changes
            </button> 
            <button onClick={(e)=>handleEditTutorial(e)} className="bg-custom-blue text-white py-2 px-6 text-sm rounded-md  hover:bg-gray-700 transition duration-150 ease-out">
             Save 
            </button> 
              </div>
            </form>
