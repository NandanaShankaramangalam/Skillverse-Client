  ...
  const closeEditModal = () => {
    ...
    const handleSubmit = async(e: React.FormEvent) => {
      ...
      if((category.trim()).length === 0){
          ...
          const {data} = await api.post('/admin/edit-category',{category,cid:props.cid},{withCredentials:true})
  ...
  return (
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg">
      ...
      <div className='flex justify-end'>
          <button onClick={closeEditModal}><FontAwesomeIcon icon={faXmark}></FontAwesomeIcon></button>
      </div>
